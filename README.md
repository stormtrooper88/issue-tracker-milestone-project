...
<a href="https://tcb-issue-tracker-app.herokuapp.com/">Tracker</a> Full Stack Frameworks with Django-Milestone project
...
I worked on my wireframes before starting to create this project. I made several wireframes using Balsamiq focusing on the home page, sign up, log in, bug, bug edit, feature, feature edit and checkout pages. I also create the same page but changed them, so it suited the device the user was using <a href="https://github.com/stormtrooper88/issue-tracker-milestone-project/blob/master/Wireframes/issue%20tracker.pdf">These files</a>. 
...
ii.	Here I can see the feature I want to pay for.
...
v.	Once this is paid, the user is informed of the payment. If there is an issue, the user is informed. 
...
https://tcb-issue-tracker-app.herokuapp.com/

The difference between the development and deployed version is that in development I used SQLite as the database whereas for the deployed version I used PostgresSQL as the database. This was run using Python3. 
...
•	All content is of my own work through the videos provided by Code Institute’s  E-commerce mini project and Blog project. 
